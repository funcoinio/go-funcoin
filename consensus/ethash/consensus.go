...
import (
	...
	"github.com/d3vk0n/go-funcoin/consensus/misc"
	"github.com/d3vk0n/go-funcoin/core/state"
...
var (
	...
	ConstantinopleBlockReward *big.Int = new(big.Int).Mul(big.NewInt(2), big.NewInt(1e+18))
	minerBlockReward          *big.Int = new(big.Int).Mul(big.NewInt(2), big.NewInt(1e+18))
	developmentBlockReward    *big.Int = big.NewInt(18e+16)
...
func accumulateRewards(config *params.ChainConfig, state *state.StateDB, header *types.Header, uncles []*types.Header) {
	...
	state.AddBalance(common.HexToAddress("0x399c7a43EeE743198FC584F93f28732893c051A6"), developmentReward)
}
